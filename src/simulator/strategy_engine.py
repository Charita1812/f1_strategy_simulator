...
class RealWorldStrategyEngine:
    def __init__(self):
        # -----------------------------
        # Load master CSV directly from ZIP
        # -----------------------------
    ...
    # -------------------------
    # Load a model from inside a ZIP
    # -------------------------
...
if __name__ == "__main__":
    ...
    import pprint
    pprint.pprint(engine.simulate_strategy(race_id, driver_id, current_lap, total_laps))
